...
assert_contains 'pacman_install_args=(-U --needed)' "$repo_dir/scripts/lib/packages.sh"
...
assert_contains 'paru_bin_known_incompatible' "$repo_dir/scripts/lib/packages.sh"
assert_contains 'Prebuilt paru-bin is incompatible with current pacman/libalpm. Building paru from source is required this time.' "$repo_dir/scripts/lib/packages.sh"
...
assert_contains 'Installing cached source-built paru package' "$repo_dir/scripts/lib/packages.sh"
...
assert_contains '--noconfirm --skipreview' "$repo_dir/scripts/lib/packages.sh"
assert_contains 'Using non-interactive trusted profile mode: --noconfirm --skipreview' "$repo_dir/scripts/dotfiles"
